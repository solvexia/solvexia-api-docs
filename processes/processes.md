...
Successful response contains a list of [Process List Item](./schemas.md)s.
...
Returns an instance of a [Process](./schemas.md/).
...
#### Response body
Successful response contains an instance of a [Process](./schemas.md/).
